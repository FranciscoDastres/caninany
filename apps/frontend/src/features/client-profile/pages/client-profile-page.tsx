  ...
  return (
    <section className="min-h-screen bg-[#eef2e8] px-5 pb-20 pt-32 sm:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-4 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-3 text-[#66766e]">
              Revisa tus compras y comprobantes de Caninany.
            </p>
          </div>
        ...
        <div className="mt-10 overflow-hidden rounded-[2rem] border border-[#e0d8cd] bg-white shadow-[0_18px_60px_rgba(35,67,52,0.08)]">
                    ...
                    <tr key={purchase.id} className="text-sm text-[#40574c]">
                      ...
                      <td className="px-8 py-5 text-right">
                        {purchase.receiptUrl ? (
                          ...
                          <span className="text-[#929b96]">No disponible</span>
                        )}
                      </td>
                    </tr>
                  ))}
